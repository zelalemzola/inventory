...
export function NewProductForm() {
    ...
    // Update SKUs when relevant fields change
    useEffect(() => {
        if (productName && category) {
            const newSku = generateSKU(productName, category, undefined, skuFormat === "custom" ? skuPrefix : undefined)
            setMainSku(newSku)
    ...
    }, [productName, category, skuPrefix, skuFormat])
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div className="space-y-6">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <Tabs value={skuFormat} onValueChange={(value) => setSkuFormat(value as "standard" | "custom")}>
                                    ...
                                    <TabsContent value="standard" className="space-y-4 pt-4">
                                        <div>
                                            <p className="text-sm text-muted-foreground mb-2">
                                                Standard SKUs are generated using category prefix, product name, and a unique number.
                                            </p>
                                            <div className="flex items-center space-x-2">
                                    ...
                                    <TabsContent value="custom" className="space-y-4 pt-4">
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    <FormLabel>Custom SKU Prefix</FormLabel>
                                                    <FormControl>
                                                        <Input placeholder="Enter custom prefix (e.g., BP)" {...field} />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
                                        ...
                                        <p className="text-xs text-muted-foreground">Format: PREFIX-PRODUCTID-RANDOM</p>
                                    </TabsContent>
                                </Tabs>
                            </CardContent>
                        </Card>
