...
export function BackupSettings() {
    ...
    const fetchBackups = async () => {
        try {
            ...
            toast("Failed to load backup history")
        } finally {
            setLoading(false)
        }
    }
    ...
    const createBackup = async () => {
        try {
            ...
            toast("Your data has been backed up successfully")
    ...
    const downloadBackup = async (id: string) => {
        try {
            ...
            toast("Your backup file has been downloaded")
        } catch (error) {
    ...
    const deleteBackup = async (id: string) => {
        ...
        try {
            ...
            toast("The backup has been deleted successfully")
    ...
    const restoreBackup = async (id: string) => {
        ...
        try {
            ...
            toast("Your data has been restored successfully")
        } catch (error) {
            console.error("Error restoring backup:", error)
            toast("Failed to restore backup")
        } finally {
            setTimeout(() => {
                setBackupInProgress(false)
                setProgress(0)
